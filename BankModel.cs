...
namespace BankOfBIT.Models
{
    ...
    ///
    /// <summary>
    /// This is an example of a c# class. barebones as much as possible
    /// </summary>
    ///
    public class someCSharpClass
    {
        // This is an autogenerated property that closely resembles a getter and setter method. instead of two seperate
        // getters and setters, we have only one line of code that handles it.
        public int propertyNumber { get; set; }
        
        ///
        /// <summary>This is an example of a method</summary>
        ///
        public double decimalNumber()
        {
            // this is a declaration of a primitive variable. it is just a double.
            double numberToReturn;
            
            // using the variable and setting values in it. 
            numberToReturn = 1.11;
            
            // methods that are not void must return a value. 
